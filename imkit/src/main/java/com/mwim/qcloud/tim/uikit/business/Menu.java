...
public class Menu {
    ...
    public void show() {
        ...
        View menuView = LayoutInflater.from(mActivity).inflate(R.layout.pop_menu_conversation, null);
        // 设置布局文件
        ...
        mMenuWindow.setBackgroundDrawable(ContextCompat.getDrawable(mActivity,R.drawable.top_pop));
